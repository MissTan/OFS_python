...
plt.plot(mistake_list, color="black")
# plt.plot(mistakes1, color="green")
# plt.plot(mistakes2, color="blue")
# plt.plot(mistakes3, color="yellow")
# plt.plot(mistakes4, color="red")
