...
plt.plot(mistake_list[::10], color="red")
plt.plot(er1_list[::10], color="green")
plt.plot(er2_list[::10], color="blue")
plt.plot(er3_list[::10], color="yellow")
plt.plot(er4_list[::10], color="black")
plt.show()
